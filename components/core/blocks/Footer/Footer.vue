<template>
 <div>      
   <footer class="sdg-footer brdr-bottom-1 brdr-top-1 brdr-cl-gainsboro py-xs-30 level-1">
      <div class="container">
        <div class="row">
            <div class="col-xs-12">
               <div class="row">
                  <div class="col-lg-3 col-xs-12 pb-xs-30 pb-md-0">
                      <div class="footer-help">
                          <h3>Need help?</h3>
                          <p><router-link :to="localizedRoute('/reach-us')" class="fontWeight-700">Reach out to us</router-link> on any of the support channel </p>
                      </div>
                  </div>
                  <div class="col-lg-6 col-xs-12">
                      <ul class="d-md-flex between-md m0">
                        ...
                        <li class="flex footer-help mb-xs-20 mb-md-0">
                          <div  class="mr15 flex align-item-center">
                            <Icon icon-id="feedback" class="level1-icon" />
                          </div>
                          <div>
                            <h3>Feedback</h3>
                            <p>Send us you feedback</p>
                          </div>
                        </li>
                        <li class="flex footer-help">
                          <div  class="mr15 flex align-item-center">
                           <Icon icon-id="get-in-touch" class="level1-icon" /> 
                          </div>
                          <div>
                            <h3>Get in Touch</h3>
                            <p>600 502 034</p>
  ...
  <footer class="sdg-footer pt-md-30 mb-md-25 level-2">
      <div class="container">
        <div class="row">
            <div class="col-md-2 col-xs-12">
              <div class="footer-links">
                <h5 @click="makeActive(1)" :class="{ 'icon--active': activePanel === 1 }">Customer Service
                ...
                <transition v-on:before-enter="beforeEnter" v-on:enter="enter" v-on:before-leave="beforeLeave" v-on:leave="leave">
                  <ul class="menu-links">
                    <li v-for="links in customerservice" :key="links.redirectText"><a :href="links.redirectUrl">{{ links.redirectText }}</a></li>                
                  </ul>
                 </transition>
              </div>
            </div>
            <div class="col-md-2 col-xs-12">
              <div class="footer-links">
                <h5 @click="makeActive(2)" :class="{ 'icon--active': activePanel === 2 }">About Us
                  <div class="plus alt"></div>
                </h5>
                <ul class="menu-links">
                  <li>About Sharaf DG</li>
            ...
            <div class="col-md-2 col-xs-12">
              <div class="footer-links">
                <h5 @click="makeActive(3)" :class="{ 'icon--active': activePanel === 3 }">Sell With Us
                  <div class="plus alt"></div>
                </h5>
                <ul  class="menu-links">
                  <li>Sell Products on Sharaf DG</li>
            ...
            <div class="col-md-3 col-xs-12">
              <div class="footer-links">
                <h5 @click="makeActive(4)" :class="{ 'icon--active': activePanel === 4 }">Payment Method
                  <div class="plus alt"></div>
                </h5>
                <ul class="menu-links">
                  <li>
                    <div class="row">
                      <div class="col-xs-12 col-md-10">
                        <ul class="flex flex-wrap payment-method">
                          <li>
                            <img src="https://dummyimage.com/60x40/aaa/222" alt="" />
                          </li>
                          <li>
                            <img src="https://dummyimage.com/60x40/aaa/222" alt="" />
                          </li>
            ...
            <div class="col-md-3 col-xs-12">
              <div class="footer-links">
                <h5 @click="makeActive(5)" :class="{ 'icon--active': activePanel === 5 }">Sharaf Newsletter
                  <div class="plus alt"></div>
                </h5>
                <ul class="menu-links">
                    <li>
                    ...
                    <div class="flex py-xs-20">
                        <ul class="flex flex-lg-wrap">
                          <li><a href=""><Icon icon-id="social-facebook" class="social-icon" /></a></li>
                          <li><a href=""><Icon icon-id="social-instagram" class="social-icon" /></a></li>
                          <li><a href=""><Icon icon-id="social-Pinterest" class="social-icon" /></a></li>
                          <li><a href=""><Icon icon-id="social-youtube" class="social-icon" /></a></li>
                          <li><a href=""><Icon icon-id="android" class="social-icon" /></a></li>
                          <li><a href=""><Icon icon-id="apple" class="social-icon" /></a></li>
                        </ul>
                    </div>
                  </li>
                </ul>
    ...
    <footer class="sdg-footer level-3 brdr-bottom-1 brdr-cl-gainsboro py-xs-28 d-none d-md-block">
      <div class="container">
        <div class="row">
            <div class="col-xs-12">
               <div class="row">
                  <div class="col-md-3 col-xs-12">
                      <div class="footer-help">
                          <h4 class="fontWeight-400">Make money with us!</h4>                         
                      </div>
                  </div>
                      ...
                      <ul class="d-xs-flex between-md m0">
                        <li class="flex middle-md footer-help pr-md-45">                          
                          <div>
                            ...
                            <p>Start selling with us and reach millions of our customers. <a href="" class="fontWeight-700 inline-flex align-content-center">Learn More <Icon icon-id="RightArrow" class="rt-arrow" /></a></p>
                          </div>
                        </li>
                        <li class="flex middle-md footer-help">                          
                          <div>
                            <h3>Become our affilliate</h3>
                            <p>Start selling with us and reach millions of our customers. <a href="" class="fontWeight-700 inline-flex align-content-center">Learn More <Icon icon-id="RightArrow" class="rt-arrow" /></a></p>
                          </div>
                        </li>                        
                      </ul>
   ...
   <footer class="sdg-footer level-4 py-xs-28">
      <div class="container">
        <div class="row">
            <div class="col-md-3">
                <Icon icon-id="sharaf-logo-long" class="footer-logo" />
            </div>
            <div class="col-md-5 flex center-lg py-xs-8 py-md-0">
              <p class="copy-right m0">Copywrite © 2021 Sharaf DG LLC. All Rights Reserved</p>
            </div>
            <div class="col-md-4">
              <ul class="flex end-lg">
       ...
       <back-to-top bottom="20px" right="20px" visibleoffset="200">
        <button type="button" class="no-outline brdr-none back-to-top">
            <Icon icon-id="UpArrow" class="uparrow" />
        </button>
      </back-to-top>
   </footer>


  <footer :class="{ 'brdr-top-1 brdr-cl-secondary': isCheckoutPage }" style="display:none">
  ...
  name: 'MainFooter',
   ...
   data: function() {
    return {
        ...
        "customerservice": [
            {
            "redirectText": "Help Centre",
            "redirectUrl": "/en/pages/Help-Centre",
            "redirectOpenNewTab": true
            },
            {
            "redirectText": "Delivery",
            "redirectUrl": "/en/pages/Delivery",
            "redirectOpenNewTab": true
            },
            {
            "redirectText": "Return & Exchange",
            "redirectUrl": "/en/support/Return-Exchange",
            "redirectOpenNewTab": false
            },
            {
            "redirectText": "Warranty",
            "redirectUrl": "/en/pages/Warranty",
            "redirectOpenNewTab": false
            },
            {
            "redirectText": "Sharaf DG Rewards",
            "redirectUrl": "/en/support/Sharaf-DG-Rewards",
            "redirectOpenNewTab": false
            },
            {
            "redirectText": "Bulk Orders Enquiries",
            "redirectUrl": "/en/support/Bulk-Orders-Enquiries",
            "redirectOpenNewTab": false
            },
            {
            "redirectText": "Store Locator",
            "redirectUrl": "/en/support/Store-Locator",
            "redirectOpenNewTab": false
            },
            {
            "redirectText": "FAQ",
            "redirectUrl": "/en/support/FAQ",
            "redirectOpenNewTab": false
            }
          ]
    };
