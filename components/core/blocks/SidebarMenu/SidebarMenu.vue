<template>
  <div class="sidebar-menu fixed mw-100 bg-cl-white">
    <div class="row brdr-bottom-1 brdr-cl-bg-white">
      <div
        v-if="submenu.depth"
        class="col-xs bg-cl-white"
      >
        <sub-btn type="back" class="bg-cl-transparent brdr-none" />
      </div>
      <div class="col-xs bg-cl-white">
        <button
          type="button"
          :aria-label="$t('Close')"
    ...
    <div class="sidebar-menu__container row" ref="container">
      <div class="col-xs-12 h4 serif">
        <ul class="p0 m0 relative sidebar-menu__list" :style="mainListStyles">
          <li
            @click="closeMenu"
            class="brdr-bottom-1 brdr-cl-bg-secondary bg-cl-white"
          >
            <router-link
          ...
          <li
            class="brdr-bottom-1 brdr-cl-bg-secondary bg-cl-white flex"
            :key="category.slug"
            @click="closeMenu"
          ...
          <li
            @click="login"
            class="brdr-bottom-1 brdr-cl-secondary bg-cl-white flex"
          >
            <sub-btn
              v-if="currentUser"
              id="my-account-links"
