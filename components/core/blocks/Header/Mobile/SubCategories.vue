    ...
    <div class="bg-cl-white z-xs-1 absolute h-100 w-100 top-0 left-0" >
        <div class="d-xs-flex flex-xs-column" >
            ...
            <div class="h-100vh overflow-xs-auto">
                <ul class="py-xs-10">
                    <li class="px-xs-20 py-xs-10 relative "
                    ...
                    <transition name="slide-down">
                        <ul class="pt-xs-10 acc-menu">
                            <li class="px-xs-10 py-xs-5 font-normal"
                            v-for="(submenu2,index) in submenu.subcategories" :key="index"> 
                                <router-link :to="localizedRoute(submenu.url)" class="link-dark">
                                    {{submenu2.name}}
                                </router-link>
                            </li>
                        </ul>
